 ...
 */
final class Version20250309162725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id_game INT AUTO_INCREMENT NOT NULL, id_line INT NOT NULL, id_user INT NOT NULL, game_mode VARCHAR(255) NOT NULL, time DOUBLE PRECISION NOT NULL, score_points INT NOT NULL, completed_stations JSON DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_232B318C5A34A8F4 (id_line), INDEX IDX_232B318C6B3CA4B (id_user), PRIMARY KEY(id_game)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
